...
begin
  ...
  begin
    dmMain.qrPedidos.Close;
    dmMain.qrPedidos.Filtered := False;
    dmMain.qrPedidos.Filter := 'codigo_cliente = ' + edtCodigoCliente.Text;
  ...
  gdPedidos.Columns[0].Title.Caption := 'Código';
  gdPedidos.Columns[1].Title.Caption := 'Número';
  gdPedidos.Columns[2].Title.Caption := 'Data de Emissão';
  gdPedidos.Columns[3].Title.Caption := 'Código do Cliente';
  gdPedidos.Columns[4].Title.Caption := 'Valor Total';
end;
